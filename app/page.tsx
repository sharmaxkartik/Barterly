...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)] relative">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">How Skill Mint Works</h2>
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
            <div className="bg-background/50 backdrop-blur-sm border-purple-500/20 rounded-lg p-6 shadow-lg">
              ...
              <p className="text-muted-foreground">Track your skill hours and manage your transactions in one place.</p>
            </div>
            ...
            <div className="bg-background/50 backdrop-blur-sm border-purple-500/20 rounded-lg p-6 shadow-lg">
              ...
              <p className="text-muted-foreground">Browse and discover skills offered by people in your community.</p>
            </div>
            ...
            <div className="bg-background/50 backdrop-blur-sm border-purple-500/20 rounded-lg p-6 shadow-lg">
              ...
              <p className="text-muted-foreground">Conduct live skill-sharing sessions with video conferencing.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
            <Card className="bg-background/50 backdrop-blur-sm border-purple-500/20">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  "I traded my web development skills for graphic design help. Now my projects look amazing, and I've
            ...
            <Card className="bg-background/50 backdrop-blur-sm border-purple-500/20">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  "Found a copywriter to help with my website content in exchange for UI design. The process was smooth
            ...
            <Card className="bg-background/50 backdrop-blur-sm border-purple-500/20">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  "Exchanged data analysis for SEO expertise. My website traffic improved, and I got to practice my
                  skills. Win-win!"
                </p>
              </CardContent>
              <CardFooter>
      ...
      {/* About Us Section */}
      <section id="about" className="w-full py-12 md:py-24 lg:py-32 border-t border-border/40">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">About Our Team</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Meet the team behind Skill Mint, created for the hackathon project.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="bg-background/50 backdrop-blur-sm border-purple-500/20">
              ...
              <CardContent className="text-center text-sm text-muted-foreground">
                <p>Passionate about creating intuitive user interfaces.</p>
              </CardContent>
            ...
            <Card className="bg-background/50 backdrop-blur-sm border-purple-500/20">
              ...
              <CardContent className="text-center text-sm text-muted-foreground">
                <p>Specializes in building robust backend systems.</p>
              </CardContent>
              <CardFooter className="flex justify-center space-x-4">
                <Link href="https://linkedin.com/" target="_blank" rel="noopener noreferrer">
                  <Button variant="ghost" size="icon" className="text-purple-500 hover:text-purple-400">
            ...
            <Card className="bg-background/50 backdrop-blur-sm border-purple-500/20">
              ...
              <CardContent className="text-center text-sm text-muted-foreground">
                <p>Creates beautiful designs with a focus on user experience.</p>
              </CardContent>
              <CardFooter className="flex justify-center space-x-4">
                <Link href="https://linkedin.com/" target="_blank" rel="noopener noreferrer">
                  <Button variant="ghost" size="icon" className="text-purple-500 hover:text-purple-400">
          ...
          <div className="flex justify-center mt-8">
            <Link href="https://github.com/your-username/skill-mint" target="_blank" rel="noopener noreferrer">
              <Button className="gap-2 purple-gradient text-white">
                <Github className="h-5 w-5" />
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Link href="/register">
                <Button size="lg" className="purple-gradient text-white purple-glow gap-1">
                  Get for free
